        ...
        <Layout>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 m-4 sm:m-6">
                ...
                <div className="relative w-full sm:max-w-md">
                    <IoSearchOutline className="absolute left-3 top-1/2 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 m-4 sm:m-6">
                {filteredTeams.map((team) => (
                    <Link 
                        href={`/teams/${team._id}`} 
                        key={team._id}>
                        <li className="rounded-lg border-2 border-[#2c4fff] px-4 sm:px-8 py-4 
                            sm:py-6 space-y-2 flex flex-col items-center bg-[#405fff] hover:bg-[#3a58ec]">
                            <div className="w-12 sm:w-14 h-12 sm:h-14 bg-[#4f6bfb]
                            border border-[#6780ff] rounded-xl flex items-center justify-center">
                                <span className="text-lg sm:text-xl text-white font-bold">
                                    {team.teamName?.[0]}
                                </span>
                            </div>
                            <h4 className="font-semibold text-base sm:text-[20px] text-white text-center">
                                {team.teamName}
                            </h4>

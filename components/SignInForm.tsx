        ...
        <div className='flex flex-col justify-center items-center p-4 sm:p-6 lg:p-8 w-full lg:w-2/4'>
            <div className="w-full max-w-sm px-4 sm:px-0">
                ...
                <form onSubmit={handleSubmit} className='flex flex-col gap-3 lg:gap-4'>
                    ...
                    <button 
                        className='button w-full text-sm lg:text-base py-2 lg:py-3 flex items-center justify-center'
                        disabled={isLoading}>
                        {isLoading ? (
                    ...
                    <div className="flex justify-center">
                        <Link className='text-xs lg:text-sm mt-2 lg:mt-3 text-right' href={'/sign-up'}>
                            Don't have an account? <span className='hover:underline text-[#405fff] font-bold'>Sign Up</span>
                        </Link>
                    </div>
                </form>
            </div>
